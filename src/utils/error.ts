...
import { ErrorWithCode, ServerActionError } from '@/types';

/**
 * Handles server action errors by returning an object with
 * an error message and code, or throwing an error if specified.
 *
